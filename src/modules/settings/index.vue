    ...
    <div class="info settings__info">
        <div class="container info__container">
            <div class="block info__block">
                ...
                <p v-if="sErrorMessageEmail" class="error info__error">{{ sErrorMessageEmail }}</p>
            ...
            <div class="block info__block">
                ...
                <p v-if="sErrorMessageFirstName" class="error info__error">{{ sErrorMessageFirstName }}</p>
            ...
            <div class="block info__block">
                <label class="label info__label" for="lastName">
                 ...
                 <p v-if="sErrorMessageLastName" class="error info__error">{{ sErrorMessageLastName }}</p>
            ...
            <div class="block info__block">
                ...
                <p v-if="sErrorMessageUsername" class="error info__error">{{ sErrorMessageUsername }}</p>
        ...
        <button @click.prevent="saveChanges" :disabled="isSaveChangesButtonLoading" class="button settings__button">Save Changes</button>

        <p v-show="sSuccessMessageSaveChanges" class="success info__success"> {{sSuccessMessageSaveChanges}} </p>
    </div>
  </section>
</template>
...
export default defineComponent({
  setup() {
    ...
    return {
      ...
      isSaveChangesButtonLoading: computed(() => store.state.auth.isSaveChangesButtonLoading),
      sSuccessMessageSaveChanges: computed(() => store.state.auth.sSuccessMessageSaveChanges),
